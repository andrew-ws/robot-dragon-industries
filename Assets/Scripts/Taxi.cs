...
public class Taxi : Enemy {
	...
	public float angrySpeedBoost = 1.5f;
	public float carBoost = 1.5f;
	...
	void Start()
	{
		...
		sr.sprite = Resources.Load<Sprite>("Sprites/Taxi");
	...
	protected override void makeAngry()
	{
		...
		sr.sprite = Resources.Load<Sprite>("Sprites/TaxiMad");
		// change sprite
	}
}
